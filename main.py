...
GUILD_ID = 1322372786064195584  # Guild ID where command registers
# Add as many staff role IDs as you want here:
STAFF_ROLE_IDS = [1488194403439874211, 1492533967503622276, 1378414831220166806, 1377355718662950992, 1377355716259741807, 1377355725021515848, 1421236411046035507, 1494106239339204810 ]  # example: [role_id1, role_id2, ...]
